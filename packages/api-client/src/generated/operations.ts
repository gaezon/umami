...
export const operations = {
  ...
  getPublicArticleViews: {
    operationId: 'getPublicArticleViews',
    method: 'get',
    path: '/api/public/article-views',
    pathParams: [],
    queryParams: [],
    hasBody: false,
  },
...
export abstract class GeneratedUmamiClient {
   ...
   */
  getPublicArticleViews(
    input?: OperationInput<'getPublicArticleViews'>,
    options?: RequestOptions,
  ): Promise<OperationOutput<'getPublicArticleViews'>> {
    return this.execute('getPublicArticleViews', input, options);
  }
